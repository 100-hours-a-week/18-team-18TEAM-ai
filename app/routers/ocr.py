            ...
            "content": [
                ...
                },
                {
                    ...
                    "text": (
                        ...
                        "────────────────────\n"
                        "[Phone Classification Rules]\n"
                        "────────────────────\n"
                        "- If a phone number starts with \"010\" or \"+82 10\", classify it as mobile_phone.\n"
                        "- If a phone number starts with \"02\", \"031\", \"032\", \"033\", or other regional area codes, classify it as company_phone.\n"
                        "- If the label near the number includes:\n"
                        "    - \"M\", \"Mobile\", \"HP\", \"H.P\", \"Cell\", \"휴대폰\" → mobile_phone\n"
                        "    - \"Tel\", \"TEL\", \"Office\", \"대표번호\", \"전화\" → company_phone\n"
                        "- NEVER swap mobile_phone and company_phone.\n"
                        "- Use contextual labels first, then number prefix as a fallback rule.\n\n"
                        "────────────────────\n"
                        "[Output Format]\n"
                        "────────────────────\n\n"
