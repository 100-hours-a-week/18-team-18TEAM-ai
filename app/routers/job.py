...
■ role_type = developer (일반 개발자)
  → "안녕하세요, [회사] [부서]에서 [직무]로 근무하고 있는 [이름]입니다."

■ role_type = instructor (강사·튜터·멘토)
  → "[부트캠프명] [트랙]에서 [직무]로 [기술 스택 또는 과정명] 교육을 진행하고 있는 [이름]입니다."
  - "근무하고 있습니다" 절대 금지
  - "교육을 진행하고 있습니다" 또는 "강의를 진행하고 있습니다" 사용

■ role_type = student (부트캠프 수강생)
  첫 문장 형식: "{{회사}} {{부서}}에서 {{직무}}로 개발자가 되기 위해 공부하고 있는 {{이름}}입니다."
  - 회사·부서·직무·이름은 입력값을 그대로 사용. 괄호 없이 실제 값으로 작성해라.
  - "근무하고 있습니다" 절대 금지
  - 지어낸 감정·과거 경험담 절대 금지 (예: "처음에는 막막했어요", "힘들었지만")

[공통 작성 가이드]
- 웹 검색 결과가 있으면 팀·과정의 기술 스택이나 미션을 자연스럽게 언급
